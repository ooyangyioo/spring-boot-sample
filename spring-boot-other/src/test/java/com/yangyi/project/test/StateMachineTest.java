package com.yangyi.project.test;
...
//            () -> stateMachine.fireEvent(States.STATE2, Events.EVENT1, new Context()));
    ...
    public void testVerify() {
        ...
        System.err.println(stateMachine.verify(States.STATE1, Events.EVENT1));
        System.err.println(stateMachine.verify(States.STATE1, Events.EVENT2));
    }
    ...
    public void testInternalNormal() {
        ...
        target = stateMachine.fireEvent(States.STATE1, Events.INTERNAL_EVENT, new Context());
        System.err.println(target);
    }
